...
def process_file(input_path, output_path):
    ...
    def process_section(match):
        ...
        for i, slide in enumerate(slides):
            ...
            # Clean up blocks: remove leading/trailing whitespace and join internal lines
            blocks = [" ".join(b.split()) for b in raw_blocks if b.strip()]
            ...
            # Add back some padding to match original style
...
if __name__ == "__main__":
    ...
    input_file = os.path.join(cwd, "20250315/input.html")
    output_file = os.path.join(cwd, "20250315/output.html")
    
    if os.path.exists(input_file):
        process_file(input_file, output_file)
        print(f"Processed {input_file} into {output_file}")
    else:
        # Fallback to local directory if 20250315 is not a subdirectory
        ...
        if os.path.exists(input_file):
            ...
            print(f"Error: input.html not found.")
